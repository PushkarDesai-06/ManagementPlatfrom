...
interface AddTaskMobilePopupProps {
  onClose: () => void;
}

const AddTaskMobilePopup = ({ onClose }: AddTaskMobilePopupProps) => {
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="flex gap-3 justify-end">
            ...
            <button
              type="submit"
              disabled={isPending || !todoContent.trim()}
...
export default AddTaskMobilePopup;
